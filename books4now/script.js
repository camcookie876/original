document.addEventListener("DOMContentLoaded", () => {
  ...
  menu.addEventListener("click", (e) => {
    ...
    if (action === "camcookie") {
      window.location.href = "https://camcookie876.github.io/original/";
    }
  ...
  const mainLinks = [
    ...
    { name: "Camcookie", url: "https://camcookie876.github.io/original/" },
    { name: "Books", url: "/original/books4now/" },
    { name: "Series", url: "/original/books4now/series/" },
    { name: "Authors", url: "/original/books4now/author/" },
